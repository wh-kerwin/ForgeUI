...
pub fn schema() -> Value {
    json!({
        ...
        "properties": {
            ...
            "batchActions": {"type": "array", "maxItems": 10, "items": {"type": "object", "additionalProperties": false, "required": ["operation_id", "method", "path", "payloadBuilder"], "properties": {"operation_id": {"type": "string"}, "method": {"enum": ["POST", "DELETE"]}, "path": {"type": "string"}, "confirmMessage": {"type": "string", "maxLength": 500}, "payloadBuilder": {"type": "object", "additionalProperties": false, "required": ["type"], "properties": {"type": {"enum": ["ids", "custom"]}, "customPayload": {"type": "string"}}}}}}
