...
export function WorkbenchSidebar({ route, onNavigate, onNotice, projects, activeProjectId, onProjectSelect, onProjectCreate, onProjectRename, onProjectDelete }: Props) {
